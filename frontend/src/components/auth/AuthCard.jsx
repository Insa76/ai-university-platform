    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r from-primary-500 to-primary-600 mb-4 shadow-lg">
        ...
        {showFooter && (
          <div className="text-center mt-6">
            <p className="text-gray-600">
              {footerText}{' '}
              <Link href={footerLink} className="font-semibold text-primary-600 hover:text-primary-700">
                {footerLinkText}
              </Link>
            </p>
          </div>
